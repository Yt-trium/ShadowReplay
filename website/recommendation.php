...
<html lang="fr">
<head>
  <title>Shadow Replay - Recommandation</title>
  <meta charset="utf-8">
  ...
  <div class="row pagination_row">
    ...
    <div class="col-sm-9 pagination_col">
      <ul class="pagination">
        <?php
        if($page == 0)
          echo '<li class="disabled"><a href="subscribe.php?page=' . $page . '">' . '<' . '</a></li>';
        else
          echo '<li><a href="subscribe.php?page=' . ($page-1) . '">' . '<' . '</a></li>';

        echo '<li class="active"><a href="subscribe.php?page=' . $page . '">' . $page . '</a></li>';
        echo '<li><a href="subscribe.php?page=' . ($page+1) . '">' . '>' . '</a></li>';
        ?>
      </ul>
    </div>
